...
import com.example.composeintegration.fragments.compose.person_details.PersonDetailsComposeFragment
...
interface ApplicationComponent {
    ...
    fun inject(personDetailsComposeFragment: PersonDetailsComposeFragment)
}